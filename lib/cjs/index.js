...
var PipeValueFactory = /** @class */ (function () {
    ...
    PipeValueFactory.prototype.clearActionList = function () {
        this.actionList = [];
    };
    // 在Action的list中添加一项Action
    PipeValueFactory.prototype.appendActionItemByActionValue = function (action, actionValue) {
        var findActionValue = this.actionList.find(function (item) { return item.value === actionValue; });
        if (findActionValue) {
            var newList = findActionValue.list || [];
            newList.push(action);
    ...
    PipeValueFactory.prototype.appendAction = function (action) {
        this.actionList.push(action);
    };
    PipeValueFactory.prototype.forEachActionList = function (list) {
        return __awaiter(this, void 0, void 0, function () {
            var _i, list_1, action;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        if (!(action.list && action.list.length > 0)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.forEachActionList(action.list)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
    ...
    PipeValueFactory.prototype.callActionListValue = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // 执行完后进行清空actionList
                    return [4 /*yield*/, this.forEachActionList(this.actionList)];
                    case 1:
                        // 执行完后进行清空actionList
                        _a.sent();
                        return [2 /*return*/];
...
// 创建传入的start方法
function createCustomStartFunction(valueFactory, _a) {
    var _this = this;
    ...
    var _loop_1 = function (key, value) {
        formattedCustomStart[key] = function (custom) {
            ...
            return __assign(__assign(__assign({}, createPipeEnd(valueFactory)), createCustomStartFunction(valueFactory, { config: config })), createPipe(valueFactory, {
                config: config,
...
// 创建pipe方法
function createPipe(valueFactory, _a) {
    var config = _a.config, customFunctionInMap = _a.customFunctionInMap;
    return __assign(__assign({ pipe: function (custom) {
            ...
            return __assign(__assign(__assign({}, createPipe(valueFactory, {
                config: config,
                customFunctionInMap: customFunction
            })), createPipeEnd(valueFactory)), createCustomStartFunction(valueFactory, { config: config }));
        } }, createPipeEnd(valueFactory)), createCustomStartFunction(valueFactory, { config: config }));
}
// 创建pipeEnd方法
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: 
                        // 顺序执行方法
                        return [4 /*yield*/, valueFactory.callActionListValue()];
                        case 1:
                            // 顺序执行方法
                            _a.sent();
                            // 清空方法
...
function createPipeCore(value, config) {
    ...
    return createCustomStartFunction(_value, { config: config });
}

exports.createPipeCore = createPipeCore;
